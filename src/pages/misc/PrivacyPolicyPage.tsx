...
const PrivacyPolicyPage = () => {
  ...
  return (
    <div>
      ...
      <div className='max-w-[390px] w-full m-auto mt-[34px] px-6'>
        ...
        <section className={styles.termsSection}>
          ...
          <ul className={styles.termsList}>
            ...
            <li>
              <p>
                회사는 제2항의 공지는 본 방침 개정의 시행일로부터 최소 1일
              ...
              <ul>
                ...
                <li>
                  <p>
                    ...
                    수신자에게 개인정보의 수집출처를 고지하고 전화권유를 하는
                    경우
                  </p>
                </li>
              </ul>
        ...
        <section className={styles.termsSection}>
          ...
          <ul className={styles.termsList}>
            ...
            <li>
              <p>
                제1항에도 불구하고 회사는 이용자가 만 14세 미만의 아동일
