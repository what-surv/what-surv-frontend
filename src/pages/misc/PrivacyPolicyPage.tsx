    ...
    <div className='max-w-[342px] w-full m-auto'>
      <div className='flex flex-col gap-4 pb-[20px]'>
        <p>
          <Typography
            ...
            text='🔒'
            weight='Bold'
            className='relative -left-[20px] text-neutral-800 text-[70px] leading-[70px]'
          />
        </p>
        <Typography size='xl2' text='개인정보처리방침' weight='Bold' />
      </div>
      <section className={styles.termsSection}>
        ...
        <p>
          <Typography
            size='xs'
            text='SurveyIT&#40;이하 ‘회사	&#39;라고 함&#41;는 회사가 제공하고자 하는 서비스&#40;이하 ‘회사 서비스’&#41;를 이용하는 개인&#40;이하 ‘이용자’ 또는 ‘개인’&#41;의 정보&#40;이하 ‘개인정보’&#41;를 보호하기 위해, 개인정보보호법, 정보통신망 이용촉진 및 정보보호 등에 관한 법률&#40;이하 &#39;정보통신망법&#39; &#41; 등 관련 법령을 준수하고, 서비스 이용자의 개인정보 보호 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보처리방침&#40;이하 ‘본 방침’&#41;을 수립합니다.'
            weight='Regular'
          />
        </p>
      </section>
      ...
      <section className={styles.termsSection}>
        <Typography size='xs' text='제3조&#40;본 방침의 공개)' weight='Bold' />
      ...
      <section className={styles.termsSection}>
        <Typography size='xs' text='제4조(본 방침의 변경)' weight='Bold' />
        <ul className={styles.termsList}>
          <li>
            <p>
          ...
          <li>
            <p>
              회사는 제2항의 공지는 본 방침 개정의 시행일로부터 최소 1일 이전에
      ...
      <section className={styles.termsSection}>
        ...
        <ul className={styles.termsList}>
          <li>
            <p>필수 수집 정보: 이메일 주소, 성별, 이름 및 휴대폰 번호</p>
          </li>
          <li>
            <p>선택 수집 정보: 닉네임, 생년월일</p>
          </li>
        </ul>
      </section>
      ...
      <section className={styles.termsSection}>
        <Typography size='xs' text='제7조&#40;기타 수집 정보)' weight='Bold' />
        ...
        <ul className={styles.termsList}>
          <li>
            <p>수집목적: 서비스 이용 현황 수집 및 개선을 위한 정보</p>
          </li>
          <li>
            <p>수집정보: 서비스 이용기록, 쿠키, 접속지 정보, 기기정보</p>
          </li>
        </ul>
      </section>
      ...
      <section className={styles.termsSection}>
        <Typography size='xs' text='제9조&#40;개인정보의 이용)' weight='Bold' />
        <p>
          <Typography
            size='xs'
      ...
      <section className={styles.termsSection}>
        <Typography
          size='xs'
          text='제11조&#40;법령에 따른 개인정보의 보유 및 이용기간)'
          weight='Bold'
        />
      ...
      <section className={styles.termsSection}>
        ...
        <ul className={styles.termsList}>
          ...
          <li>
            <p>
              제1항에도 불구하고 회사는 이용자가 만 14세 미만의 아동일 경우에는,
              그 아동의 법정대리인으로부터 그 아동의 개인정보 수집, 이용, 제공
      ...
      <section className={styles.termsSection}>
        <Typography size='xs' text='제17조&#40;이용자의 의무)' weight='Bold' />
        <ul className={styles.termsList}>
          <li>
            <p>
      ...
      <section className={styles.termsSection}>
        ...
        <p>
          <Typography
            size='xs'
            text='회사는 개인정보의 분실·도난·유출(이하 "유출 등 "이라 한다)
      ...
      <section className={styles.termsSection}>
        <Typography
          size='xs'
          text='제19조&#40;개인정보 유출 등에 대한 조치의 예외)'
          weight='Bold'
        />
        <p>
          <Typography
      ...
      <section className={styles.termsSection}>
        <Typography
          size='xs'
          text='제20조&#40;개인정보 자동 수집 장치의 설치·운영 및 거부에 관한 사항)'
          weight='Bold'
        />
        <ul className={styles.termsList}>
          <li>
            <p>
              ...
              저장하고 수시로 불러오는 개인정보 자동 수집장치(이하 &#39;쿠키
              &#39;)를 사용합니다. 쿠키는 웹사이트를 운영하는데 이용되는
        ...
        <ul className={styles.termsList}>
          <li>
            ...
            <ul>
              ...
              <li>
                <p>전화번호: 01041733458</p>
              </li>
              <li>
                <p>이메일: SurveyIT2024@gmail.com</p>
              </li>
            </ul>
          </li>
        </ul>
      ...
      <section className={styles.termsSection}>
        ...
        <p>
          <Typography
            size='xs'
            text='제1조 본 방침은 2024.02.27부터 시행됩니다.'
            weight='Regular'
          />
        </p>
      </section>
