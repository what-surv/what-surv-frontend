            ...
            <div className='flex items-center self-stretch justify-center gap-2 mt-4 LoginButton'>
              {handleClose !== undefined && (
                <button
                  type='button'
                  onClick={handleClose}
                  className='flex w-[86px] sm:w-[114px] h-[50px] bg-neutral-50 rounded-[400px] border-2 border-blue-600 flex-col justify-center items-center gap-2.5 '
                >
                  아니요
                </button>
              )}
              <button
                type='button'
                onClick={goLogin}
                className='flex grow w-[calc(100%-86px)] sm:w-[calc(100%-114px)] h-[50px] bg-blue-600 rounded-[400px] flex-col justify-center items-center gap-2.5 text-[#FFFFFF]'
              >
                간편 로그인하기
              </button>
            </div>
