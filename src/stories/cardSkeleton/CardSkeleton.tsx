  ...
  return (
    <div>
      {type === 'default' ? (
        ...
        <div className='CardSkeleton2 animate-pulse w-[340p2] h-44 p-5 bg-neutral-50 rounded-2xl border border-neutral-300 flex-col justify-start items-start gap-9 inline-flex'>
