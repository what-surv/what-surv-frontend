  ...
  return ReactDOM.createPortal(
    <>
      ...
      <div className='fixed top-0 left-0 z-50 flex items-center justify-center flex-shrink-0 w-full h-screen mx-auto'>
        <div className='flex w-[90%] justify-center items-center max-w-[504px] bg-[#FBD6D4] gap-6 md:gap-10 p-10 flex-col rounded-2xl'>
          <Typography
            size='xl'
          ...
          <div className='flex items-center self-stretch justify-center'>
            <button
              type='button'
              onClick={handleClose}
              className='rounded-[400px] text-[#242424] flex items-center py-3 px-6 border-2 flex-col gap-2.5 flex-1 justify-center border-[#0051FF]'
            >
              취소
            </button>
            <button
              ...
              className='rounded-[400px] flex text-white items-center py-3 px-6 bg-[#0051FF] flex-col gap-2.5 flex-1 justify-center'
            >
              뒤로가기
            </button>
          </div>
